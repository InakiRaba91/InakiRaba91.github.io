...
<figure style="text-align: center;">
  <img src="/Ovni1.png" alt="Ovni flying above the camera" width="200" style="display: block; margin: auto;">
...
![Untitled](/ChangeOfBasis.png)

The origin of coordinates in the camera system is located at $r=[r_x,r_y]$ w.r.t. the world system. Following this observation, we can infer that in order to align both origin of coordinates $O$ and $O'$, we just need to apply a shift given by the vector $t$:

![Untitled](/ChangeOfBasis2.png)

However, we still need to account for the rotation between the axes, given by angle $\varphi$. 

![Untitled](/ChangeOfBasis3.png)
