...
**Note**: you can give it a try by simply running this [script](https://github.com/InakiRaba91/ProjectiveGeometry/blob/main/projective_geometry/entrypoints/camera_pose_from_four_points_demo_fn.py). In order to do so, just install the repository (`poetry install`) and then run 
